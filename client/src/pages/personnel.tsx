      ...
      <Card className="border-l-4 border-l-primary">
        <CardContent className="pt-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold mb-1">Personnel Business Rules</h3>
              <div className="text-sm text-muted-foreground space-y-1">
                <div>• Head location must have: General Manager (President), Deputy, Treasurer, Secretary, and Administrators</div>
                <div>• General Manager of head location is the Club President</div>
                <div>• Personnel can operate at only one location at any time</div>
                <div>• All personnel must have unique SSN and Medicare card numbers</div>
              </div>
            </div>
          </div>
        </CardContent>
